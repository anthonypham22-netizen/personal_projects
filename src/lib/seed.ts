...
const demoBuyerProjects = [
  {
    ...
    status: "active",
    thesis:
      "Acquire Canadian vertical software and managed-services businesses with C$3M-C$20M revenue and durable recurring revenue.",
    ...
    min_enterprise_value: 4_000_000,
